    ...
    public partial class Frm_Productos : Form
    {
        ...
        private void SeleccionaItem()
        {
            ...
            else
            {
                ...
                Txt_descripcion_pr.Text = Convert.ToString(Dgv_principal.CurrentRow.Cells["abreviatura_um"].Value);
        ...
        {
            if (Txt_descripcion_pr.Text == String.Empty || Txt_descripcion_um.Text == String.Empty)
            {
            ...
            else //Se procederia a registrar la informacion 
            {
                ...
                oUm.Abreviatura_um = Txt_descripcion_pr.Text.Trim();
