    ...
    public class D_Categorias
    {
        public DataTable Listado_ca(string cTexto)
        {
            ...
            try
            {
                ...
                SqlCommand Comando = new SqlCommand("USP_Listado_caNew", SQLcon);
        ...
        public string Guardar_ca(int nOpcion, E_Categorias oCa)
        {
            ...
            {
                SqlCon = Conexion.getInstancia().CrearConexion();
                SqlCommand Comando = new SqlCommand("USP_Guardar_ca4", SqlCon);
                Comando.CommandType = CommandType.StoredProcedure;
                Comando.Parameters.Add("@nOpcion", SqlDbType.Int).Value = nOpcion;
                Comando.Parameters.Add("@nCodigo_ca", SqlDbType.Int).Value = oCa.Categoria_id;
